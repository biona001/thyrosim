...
function [t,q] = thyrosim_core_original(ic,dial,inf1,inf4,tspan,fitting_index,current_iter,patient)
...
[Vp_new, Vtsh_new, Vp_ratio, SM_ratio, Vtsh_ratio] = patientParam5(patient, p(47), p(48));
...
%rate mass scaling exponent from Ellenberger paper
p(52) = current_iter(1);           
%p(53) = current_iter(2);
%p(52) = -0.25;
%p(53) = 0.75;

list_rates = [13, 15, 17, 34, 3, 4, 5, 6, 20, 21, 22, 23, 11, 28, 44, 46, 35]; %should S4 be scaled?
%list_clearances = [13, 15, 17, 34];

mass_ratio = patient(2) / 70.0;
