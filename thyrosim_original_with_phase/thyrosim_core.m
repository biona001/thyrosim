...
function [t,q] = thyrosim_core(ic,dial,inf1,inf4,tspan,phase)

% Initialize
global u1 u4 kdelay d p;
[u1,u4,kdelay,d,p] = initParams(inf1,inf4,dial,phase);
...
function [u1,u4,kdelay,d,p] = initParams(inf1,inf4,dial,phase)
