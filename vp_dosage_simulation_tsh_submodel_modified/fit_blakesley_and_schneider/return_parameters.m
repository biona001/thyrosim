function [p, d] = return_parameters(dial, fitting_index, current_iter)
    ...
    %adjuted parameters for new thyrosim
    p(1) = 0.00174155;      %S4
    p(2) = 8;               %tau
    p(3) = 0.868;           %k12
    p(4) = 0.108;           %k13
    ...
    p(29) = 0.207;          %k05
    p(30) = 101;               %Bzero -> fitted to blakesley data
    p(31) = 47.64;             %Azero -> fitted to blakesley data
    ...
    p(51) = 6.91;              %hill exponent in f_circ -> fitted to Blakesley data
    p(52) = 7.66;              %hill exponent in SR_tsh -> fitted to Blakesley data
    p(53) = 3.5;            %Km for f4
