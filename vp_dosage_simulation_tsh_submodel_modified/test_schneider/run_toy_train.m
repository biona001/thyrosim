function run_toy_train()
    %import data
    data = readtable('schneider_train_15patients.csv');
    ...
    for j = 1:size(data, 1)
        ...
        %save figure
        saveas(myfig, ['./toy_train_fiddle/', thyrosim_version, '_thyrosim/', num2str(current_patient),'.png']);
        clf('reset');
    ...
    fileID = fopen(['./toy_train_fiddle/', thyrosim_version, '_thyrosim/summary.txt'], 'w');
