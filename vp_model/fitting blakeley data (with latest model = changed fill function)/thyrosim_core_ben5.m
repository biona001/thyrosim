...
function [t,q] = thyrosim_core_ben5(ic,dial,inf1,inf4,tspan,fitting_index,current_iter,patient,phase)

    % Initialize
    global u1 u4 kdelay d p;
    [u1,u4,kdelay,d,p] = initParams(inf1,inf4,dial,fitting_index,current_iter,patient,phase);
...
function [u1,u4,kdelay,d,p] = initParams(inf1,inf4,dial,fitting_index,current_iter,patient,phase)
...
function dqdt = ODEs_old(t, q)
    ...
    %SRTSH = (p(30)+p(31)*fCIRC*sin(pi/12*t-p(33)))*exp(-q(9)); %this does not fix the period issue
