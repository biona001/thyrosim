function [p, d] = return_parameters(dial)
    ...
    p(29) = 0.207;          %k05
    p(30) = 1166/10;           %Bzero -> this guy we will fix for now because for patient with 0 secretion and no treatment will result in TSH roughyly 150
    p(31) = 581/10;            %Azero
    ...
    p(49) = 2;              %K_circ -> this we are not going to fit because we don't have TSH data on very hypothyroid patients
    p(50) = 4.8;            %K_SR_tsh
