...
function [t,q] = thyrosim_core_ben_sim(ic,dial,inf1,inf4,tspan,patient,phase,thyrosim_version)

    % Initialize
    global u1 u4 kdelay d p;
    [u1,u4,kdelay,d,p] = initParams(inf1,inf4,dial,patient,phase,thyrosim_version);
...
function [u1,u4,kdelay,d,p] = initParams(inf1,inf4,dial,patient,phase,thyrosim_version)
